<x-guest-layout>
    ...
    <section class="login-container">
        <div class="quotes">
            <h1 class="quotes__title">Login Sekarang!</h1>
            <p class="quotes__subtitle">Melangkah kembali menuju pesona alam, masuki keindahan, temukan ketenangan di
                Bukit Panyangrayan!</p>
        </div>
        <form method="POST" action="{{ route('login') }}" class="forms">
            <div class="forms__subtitle" style="margin-bottom: -2rem">SELAMAT DATANG KEMBALI</div>
            <div class="forms__title">Masuk ke dalam Akunmu</div>
            ...
            <div class="rf-container" style="margin-top: -1.2rem">
                <div class="forms__container">
            ...
            <div class="register__go forms__container">
                <p class="register__desc">Belum ada akun? <a href="{{ url('/register') }}"
                        class="register__btn">Register Di
                        Sini</a></p>
            </div>
        </form>
    </section>
