<x-app-layout>
    ...
    <form id="survey-form" class="container form-meja" action="{{ route('submit_tiket') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="nomor_hp" name="nomor_hp" min="13" max="120" placeholder="Masukkan no.HP">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="jumlah_tiket" name="jumlah_tiket" max="10" placeholder="Pilih Jumlah Tiket" required>
        </div>

        <!-- Text Area -->
        <div class="form-group">
            <label for="keterangan">Ada catatan?</label>
            <textarea class="form-textarea" id="keterangan" name="keterangan" rows="3" cols="30" placeholder="Tuliskan di sini..."></textarea>
        </div>
